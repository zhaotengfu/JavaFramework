...
import com.sd.annotation.Table;
import com.sd.entity.FieldInfo;
    ...
    private static List<FieldInfo> loadPojoSqlInfo(Class pojoClass){
        ...
        if(null == cacheMap.get(pojoClass.getName())){
            ...
            for(Field field : fields){
                ...
                if(field.isAnnotationPresent(com.sd.annotation.Field.class)){
                    String value = ((com.sd.annotation.Field)field.getAnnotation(com.sd.annotation.Field.class)).value();//得到配置的数据库字段名
                ...
                if(field.isAnnotationPresent(com.sd.annotation.PK.class)){
                    fieldInfo.setPk(true);
                }
                if(field.isAnnotationPresent(com.sd.annotation.NoInsert.class)){
                    fieldInfo.setInsert(false);
                }
                if(field.isAnnotationPresent(com.sd.annotation.NoUpdate.class)){
